<x-layout>
    ...
    <x-datatable id="modulTable" :disableOrderColumn="4">
        ...
        @foreach([
            ['name' => 'Dashboard', 'desc' => 'Pengembangan Dashboard MyCRM', 'project' => 'MyCRM'],
            ['name' => 'Sidebar', 'desc' => 'Pengembangan Sidebar RichCRM', 'project' => 'RichCRM'],
            ['name' => 'Navbar', 'desc' => 'Pengembangan Navbar MyCRM', 'project' => 'MyCRM'],
            ['name' => 'Alur Bug', 'desc' => 'Pengembangan Alur Bug', 'project' => 'RichCRM'],
            ['name' => 'Alur Sistem', 'desc' => 'Pengembangan Sistem', 'project' => 'MyLog'],
            ['name' => 'Redesign', 'desc' => 'Redesain Frontend MyCRM', 'project' => 'MyCRM'],
        ] as $index => $modul)
    ...
    <form>
        ...
        <div class="mt-6 flex justify-end gap-x-2">
            <button type="button" data-modal-hide="modulModal"
