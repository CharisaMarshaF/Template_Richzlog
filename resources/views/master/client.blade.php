<x-layout>
    ...
    <x-datatable id="clientTable" :disableOrderColumn="4">
        <x-slot:thead>
        ...
        @foreach([
        ['name' => 'FJM', 'email' => 'example@email.com', 'telp' => '09876548768'],
        ['name' => 'Besari', 'email' => 'example@email.com', 'telp' => '09876548768'],
        ['name' => 'Gacoan', 'email' => 'example@email.com', 'telp' => '09876548768']
        ] as $index => $client)
                ...
                <div class="inline-block relative">
                    ...
                    <div id="dropdownAction-{{ $index }}"
                        ...
                        <div class="py-1" role="none">
                            ...
                            <a href="#" data-modal-target="clientModal" class="custom-action-modal" role="menuitem" tabindex="-1">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <form>
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="companyPhone" class="custom-label">Company Phone *</label>
                        <div class="mt-1 relative rounded-md shadow-sm">
                ...
                <div>
                    <label for="companyAddress" class="custom-label">Company Address *</label>
                    <div class="mt-1 relative rounded-md shadow-sm">
